<div id="header">
    ...
    <?php } 
        if (isset($_SESSION['id'])) { 
            if ($tab[2] == "home.php") { ?>
    <div class="button-header" onclick="location.href='http://<?php echo $_SERVER['HTTP_POST'].$tab[1] ?>'/museum.php'">
        <span>Gallery</span>
    </div>
    <?php } else { ?>
    <div class="button-header" onclick="location.href='http://<?php echo $_SERVER['HTTP_POST'].$tab[1] ?>/home.php'">
        <span>Settings</span>
    </div>
    <?php } ?>
