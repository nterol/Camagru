...
<body>
    ...
    <div class="body-forms">
        ...
        <?php if (!isset($_SESSION)) { ?>
            <div class="container">
                <h1><?php echo htmlspecialchars("You're not connected") ?></h1>
                </br>
        ...
        <div class="container profil">
            ...
            <div class="display-username">
                ...
                <div class="notifications">
                    <form method="post" action="./forms/settings.php">
                        <input type="submit" name="notifications" value="<?php if ($profile[0]['notifications'] == 'Y')
                        echo("Désactiver les notifications");
                        else 
                        echo("Activer les notifications"); ?>">
                </div>
            </div>
        </div>
    </div>
